...
pub fn generate_all_days(year: i32, month: u32, day: u32) -> Vec<String> {
...
pub async fn get_page(params: &PageParams) -> ReqwestResult<String> {
    let client = reqwest::Client::new();
    // reqwest::get(format_request(params))
    client.get(format_request(params))
...
pub async fn get_day_posts(date: String) -> std::io::Result<usize> {
